...
<div class="crs-top">
  <div class="crs-bar crs-black crs-card">
    <a href="ticketing-client.php" class="crs-bar-item crs-button crs-padding-large crs-hover-grey">CREATE TICKET</a>
    <a href="client-tickets.php" class="crs-bar-item crs-button crs-padding-large crs-hover-grey">YOUR TICKETS</a>
